        ...
        <motion.div 
         ...
         className='rounded-xl shadow-md bg-white flex gap-2'>
           <div className='p-4'>
             ...
             <Image src='/images/imp1.webp' alt='Impact1' width={150} height={80}/>
...
className='rounded-xl shadow-md bg-white flex gap-2'>
    ...
    <Image src='/images/imp2.webp' alt='Impact2' width={150} height={80}/>
...
<motion.div 
    ...
    <Image src='/images/imp3.webp' alt='Impact3' width={150} height={80}/>
