...
const Footer = () => {
  // Footer columns - first column is now logo + description
  const footerColumns = [
    { 
      type: 'logo',
      content: {
        logo: '/logo white.png', // Path to your white logo
